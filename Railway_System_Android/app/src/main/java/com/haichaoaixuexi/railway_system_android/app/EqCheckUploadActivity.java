 ...
 */
public class EqCheckUploadActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        titleTxt.setText(R.string.local_eq_check);
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    case R.id.tv_item_click:
                        ...
                        Intent intent = new Intent(mContext, EqCheckInfoActivity.class);
                        Gson gson = new Gson();
        ...
        DialogUIUtils
                .showIsDeleteSheetDialog(mContext, "删除数据，谨慎操作", new ActionSheetDialog.OnSheetItemClickListener() {
                    ...
                    public void onClick(int which) {
                        ...
                        refresh(EqCheckUploadActivity.class);
                        showToast("数据已全部删除");
                    }
                });
    }
