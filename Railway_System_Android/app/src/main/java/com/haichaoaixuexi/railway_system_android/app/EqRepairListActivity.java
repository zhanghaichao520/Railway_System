...
/**
 * Created by haichao on 2018/4/3.
...
public class EqRepairListActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        titleTxt.setText(R.string.eq_repair_list);
    }
    ...
    private void loadDataFromLocal() {
        ...
        if (tasks != null) {
            for (int i = 0; i < tasks.size(); i++) {
                if (tasks.get(i).getTASK_PROCESS().equals("待验收")){
            ...
            if (data != null) {
                ...
                if (type==Const.TYPE_EQUIMENT&&content.length()==9){
                    ...
                    if (strs[1].trim().equals(content)){
                        Intent intent = new Intent(EqRepairListActivity.this, EquimentInfoActivity.class);
    ...
    private void divTask4Sever(int tid, int uid) {
        final Dialog dialog = DialogUIUtils.showLoadingHorizontal(EqRepairListActivity.this, "数据下载中").show();
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        if (response.body().equals("failed")) {
                            ...
                            refresh(EqRepairListActivity.class);
